...
El objetivo del segundo sprint fue completar la sincronizacion de los servicios de la app para estudiantes y completar las vistas del segmento empresas
...
| **User Story** |                                                   | **Work-Item/task** |                                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | **Estimation(Hrs)** | **Assigned To**    | **Status** |
| **ID**         | **Title**                                         | **Id**             | **Title**                                | **Description**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |                     |                    |            |
| US06           | Visualización del portafolio por gerentes         | T01                | Implementar visualización de portafolio  | Como gerente, quiero poder revisar el portafolio de un estudiante antes de seleccionarlo, para evaluar su experiencia previa.<br><br>**Escenario 1:** Visualización del enlace por parte del gerente: Dado que soy un gerente autenticado y estoy revisando el perfil de un estudiante que está postulando a uno de mis proyectos, cuando clickeo en "ver portafolio", entonces debo ser redirigido a la página de su portafolio en una nueva pestaña.                                                                                                                                                                                               | 2                   | Josue Paiva        | To Do      |
| US08           | Ver reputación de un estudiante                   | T02                | Implementar visualización de reputación  | Como gerente, quiero ver el historial de evaluación de un estudiante, para decidir si confiarle un nuevo proyecto.<br><br>**Escenario 1:** Acceso a evaluación desde el perfil del estudiante: Dado que estoy considerando un postulante, cuando entro a su perfil, entonces puedo visualizar su reputación con puntuaciones previas, feedback recibido y métricas como cumplimiento de plazos.<br>**Escenario 2:** Información clara y filtrada: Dado que quiero una lectura rápida, cuando reviso la reputación, entonces puedo ver una visualización resumida con promedio de evaluación, número de proyectos completados y etiquetas destacadas. | 2                   | Renzo Loli         | To Do      |
| US11           | Calificación de estudiante freelance              | T03                | Implementar calificación de estudiantes  | Como empresario, quiero calificar a un estudiante luego de un proyecto, para reflejar su desempeño en la aplicación móvil.<br><br>**Escenario 1:** Empresario deja una calificación: Dado que el proyecto ha finalizado, cuando el empresario accede al perfil del estudiante y completa una calificación con comentario, entonces esta debe guardarse y reflejarse públicamente.                                                                                                                                                                                                                                                                    | 2                   | Renzo Loli         | To Do      |
| US14           | Búsqueda de postulante                            | T04                | Implementar filtrado de postulantes      | Como empresario, quiero filtrar entre los postulantes a mis proyectos por carrera, habilidades y calificación previa, para encontrar más fácilmente al candidato ideal.<br><br>**Escenario 1:** Filtrado por carrera.<br>**Escenario 2:** Filtrado por habilidades.<br>**Escenario 3:** Filtrado por calificación.                                                                                                                                                                                                                                                                                                                                   | 2                   | Renzo Loli         | To Do      |
| US17           | Crear Convocatoria                                | T05                | Implementar creación de convocatorias    | Como gerente, quiero crear convocatorias en la aplicación, para recibir solicitudes de postulantes.<br><br>**Escenario 1:** Gerente crea convocatoria.<br>**Escenario 2:** Gerente crea convocatoria con información incompleta.                                                                                                                                                                                                                                                                                                                                                                                                                     | 2                   | Alessandra Becerra | To Do      |
| US18           | Editar Convocatoria                               | T06                | Implementar edición de convocatorias     | Como gerente, quiero editar convocatorias en la aplicación, para corregir o actualizar la información cuando lo necesite.<br><br>**Escenario 1:** Gerente edita convocatoria.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | 2                   | Alessandra Becerra | To Do      |
| US19           | Eliminar Convocatoria                             | T07                | Implementar eliminación de convocatorias | Como gerente, quiero eliminar una convocatoria publicada en la aplicación, para evitar recibir nuevas postulaciones cuando el proyecto cierre.<br><br>**Escenario 1:** Gerente borra convocatoria.<br>**Escenario 2:** Gerente cancela la eliminación de convocatoria.                                                                                                                                                                                                                                                                                                                                                                               | 2                   | Alessandra Becerra | To Do      |
